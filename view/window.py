...
from view.new_user_window import Ui_Dialog
...
class WindowLayout:
    def __init__(
        ...
        self.comboBox.setMinimumSize(QtCore.QSize(310, 0))
        self.comboBox.setIconSize(QtCore.QSize(16, 16))
        self.comboBox.setObjectName("comboBox")
        self.horizontalLayout_5.addWidget(self.comboBox, 0, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
